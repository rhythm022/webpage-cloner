...
现在工具支持克隆最后活动的标签页，而不仅仅是初始页面！

**主要特性**：
- 🎯 **自动跟踪新标签页**：监听并跟踪所有新打开的标签页
- 🎯 **克隆最后活动页**：等待时间结束后，克隆最后活动的标签页
- 🎯 **支持手动操作**：可以在等待期间手动点击、登录、导航
- 🎯 **完美支持跳转**：适用于点击登录后跳转到新标签页的场景
...
3. 在新标签页中完成登录
4. 导航到需要克隆的子页面
5. 等待时间结束后，工具自动克隆当前活动的标签页

### 🔧 新增参数

- `navigationTimeout`: 页面导航超时时间（毫秒，默认 60000ms）

### 🐛 Bug 修复

- 修复了导航超时时程序崩溃的问题
- 改进了页面跟踪逻辑，更准确地识别活动标签页

### 📚 文档更新

- 在 `使用示例.md` 中添加了"多标签页操作示例"章节
- 更新 `README.md` 添加多标签页功能说明
- 添加了详细的使用场景和操作流程说明
